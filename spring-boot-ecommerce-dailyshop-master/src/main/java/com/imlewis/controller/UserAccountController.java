...
public class UserAccountController {
    ...
    public String account(HttpServletRequest request, Model model) {
        ...
        model.addAttribute("customer",appUser);
...
/*
        ...
        if(customerService.hasRole("ROLE_UNAUTH", appUser)){
        	model.addAttribute("unAuth", "unAuth");
        }
        
        // Get Customer Orders
        List<CustomerOrder> customerOrders = customerOrderService.getAllCustomerOrderByCustomer(appUser);
	...
	public void resendActiveCode(HttpServletRequest request){
        ...
        AppUser appUser = customerService.findOne(customerId);
		if(appUser != null){
			if(!customerService.hasRole("ROLE_USER", appUser))
