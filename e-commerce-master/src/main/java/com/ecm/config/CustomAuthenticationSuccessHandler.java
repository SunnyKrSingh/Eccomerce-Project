    ...
    public void onAuthenticationSuccess(HttpServletRequest request, 
      HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        if(userDetails.getUsername() != null){
            // Customer name
            AppUser appUser = customerService.findByEmail(userDetails.getUsername());
            request.getSession().setAttribute("customerName_", appUser.getUserName());
            request.getSession().setAttribute("customerId_", appUser.getUserId());
            // Cart Id
